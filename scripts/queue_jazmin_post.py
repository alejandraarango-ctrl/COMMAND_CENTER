...
_COMMUNITY_CTA_INSTRUCTION = (
    ...
    "'COMUNIDAD' o 'INVERTIR' para unirse a la comunidad y aprender a "
    "invertir paso a paso -- NO menciones que es gratis/gratuita, la "
    "comunidad ya no lo es (por ejemplo: \"Comenta 'COMUNIDAD' si quieres "
    "unirte y aprender a invertir paso a paso\", o \"Escribe 'INVERTIR' y "
    "te comparto como unirte\").\n"
